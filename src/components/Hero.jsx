    ...
    <>
      ...
      <section className="w-full flex flex-col relative">
        ...
        <div className="w-full h-screen relative">
          ...
          <div className={`bg-gray-300 ${isSmallScreen ? 'text-white' : 'text-white'} md:py-5 py-3 px-4 text-center w-full relative z-20`}>
            <p className="text-[0.9rem] px-3">
              Get iPhone 16 Pro from just 65€/month for up to 24 months.* with No
        ...
        >
          ...
          <p className="text-white font-[600] text-lg md:text-xl mt-4">From €1359* or</p>
          <p className="text-white font-[600] text-lg md:text-xl ">€65/month for 24 months.‡</p>
