  ...
  return (
    <div className="flex flex-col ">
      ...
      >
        <h3>{title}</h3>
        <button
          className={`text-gray-200 text-md flex items-center md:hidden ${expand && "rotate-180"
            }`}
        >
          <svg
            stroke="currentColor"
    ...
    <div className="bg-[#1d1d1f] px-3 lg:px-52">
      ...
      <footer className="max-w-[93vw]   pt-3 pb-4 text-[12px]">
        ...
        <div className="flex flex-col-reverse md:flex-row justify-between gap-5 md:gap-0 border-t md:border-gray-700 pt-2 text-gray-400">
          <div className="flex flex-col lg:flex-row lg:items-center lg:gap-x-4 text-[12px]">
            <div className="mb-1 md:mb-0">
              <span>© 2025 Alexandru Armaș. All rights reserved.</span>
            </div>
