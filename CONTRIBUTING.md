...
- Take a look at the existing [Issues](https://github.com/alexandruarmas/iPhone16Pro/issues). 
- Fork the Repo & create a branch for any issue that you are working on and commit your work.
- At first raise an issue in which you want to work
- Then after assigning only then work on that issue & make a PR 
- Create a [**Pull Request**](https://github.com/alexandruarmas/iPhone16Pro/pulls), which will be promptly reviewed and given 
...
**1.** Start by forking the [**iPhone16Pro**](https://github.com/alexandruarmas/iPhone16Pro) repository. Click on the <a href="https://github.com/alexandruarmas/iPhone16Pro"><img src="https://i.imgur.com/G4z1kEe.png" height="21" width="21"></a> symbol at the top right corner.
...
```bash
git remote add upstream https://github.com/alexandruarmas/iPhone16Pro
```
